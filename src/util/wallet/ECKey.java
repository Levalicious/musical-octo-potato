...
import static util.byteUtils.BIUtil.isLessThan;
import static util.byteUtils.ByteUtil.bigIntegerToBytes;
...
public class ECKey implements Serializable {
    ...
    public static byte[] computeAddress(byte[] pubBytes) {
        return fromHex(walletHash(getHex(pubBytes)));
    }
